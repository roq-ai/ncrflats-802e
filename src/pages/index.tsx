...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`NCRFLATS`}</title>

        <meta
          name="description"
          content="Welcome to NCRFLATS, your ultimate Real Estate Application. Simplifying property search, buying, selling, and renting like never before."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1582407947304-fd86f028f716?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZWFsJTIwZXN0YXRlfGVufDB8fHx8MTY5MDExNTkxM3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to NCRFLATS, your ultimate Real Estate Application. Simplifying property search, buying, selling, and renting like never before.`}
            </Text>
            <Box
